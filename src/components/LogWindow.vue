<template>
  ...
  >
    ...
    >
      <!-- 窗口头部 -->
      <div
        class="flex items-center justify-between p-4 border-b border-base-300 bg-gradient-to-r from-primary/5 to-primary/10"
      >
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="tooltip tooltip-bottom" :data-tip="$t('writeFlash.clearLog')">
            <button class="btn btn-sm btn-circle btn-ghost" @click="clearLogs" :disabled="isFlashing">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-4 w-4"
                fill="none"
          ...
          <!-- 关闭按钮 -->
          <button class="btn btn-sm btn-circle btn-ghost hover:btn-error" @click="closeWindow">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-4 w-4"
              fill="none"
