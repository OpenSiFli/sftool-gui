<template>
  <div class="min-h-screen bg-base-100 py-10 px-4 md:px-8 flex flex-col">
    <div class="max-w-4xl mx-auto bg-base-200 rounded-lg shadow-md overflow-hidden w-full">
      <!-- 页面标题 - 居中放置，无底色 -->
